...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 22, 2021 at 10:43 AM
...
CREATE TABLE `kursai` (
  ...
  `trumpas-aprasas` varchar(200) NOT NULL,
  `ilgas-aprasas` varchar(3000) NOT NULL,
...
INSERT INTO `kursai` (`id`, `autorius`, `data`, `pavadinimas`, `trumpas-aprasas`, `ilgas-aprasas`, `nuotrauka`, `populiarumas`, `kaina`) VALUES
